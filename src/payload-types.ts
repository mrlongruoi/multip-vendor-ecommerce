...
export interface Tenant {
  id: string;
  /**
   * This is the name of the store (e.g. [Mrlong's Store])
   */
  name: string;
  /**
   * This is subdomain for the store (e.g. [slug].V420road.com)
   */
  slug: string;
...
/**
 * You must submit your account brefore creating products
 *
 * This interface was referenced by `Config`'s JSON-Schema
